...
CHANNEL_SETUP2 = 14
SEND_CCS = [[x + i for x in (40, 60, 80, 100)] for i in range(16)]
PAN_X_CC = list(range(20, 36))
PAN_Y_CC = list(range(16))
PAN_X_MASTER_CC = 36
PAN_Y_MASTER_CC = 16
...
EQ_CCS = [[x + i for x in (40, 60, 80, 100)] for i in range(16)]
SLOT_LAUNCH_NOTES1 = [list(range(i * 8, i * 8 + 6)) for i in range(16)]
SLOT_LAUNCH_NOTES2 = [
    [6, 7, 55, 56, 57, 58],
    [14, 15, 59, 60, 61, 62],
    [22, 23, 63, 64, 65, 66],
