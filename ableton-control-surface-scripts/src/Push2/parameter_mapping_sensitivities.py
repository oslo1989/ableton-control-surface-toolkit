...
PARAMETER_SENSITIVITIES = {
    "UltraAnalog": {
        "OSC1 Octave": {DEFAULT_SENSITIVITY_KEY: 0.05},
    ...
    "LoungeLizard": {
        "Noise Pitch": {DEFAULT_SENSITIVITY_KEY: 0.5},
    ...
    "InstrumentImpulse": {
        "1 Transpose": {DEFAULT_SENSITIVITY_KEY: 0.1},
    ...
    "OriginalSimpler": {
        "Zoom": {DEFAULT_SENSITIVITY_KEY: 1},
    ...
    "Operator": {
        "Oscillator": {DEFAULT_SENSITIVITY_KEY: 0.5},
    ...
    "MidiArpeggiator": {
        "Style": {DEFAULT_SENSITIVITY_KEY: 0.1},
    ...
    "MidiScale": {"Base": {DEFAULT_SENSITIVITY_KEY: 0.5}, "Transpose": {DEFAULT_SENSITIVITY_KEY: 0.5}},
    "Amp": {
        "Bass": {DEFAULT_SENSITIVITY_KEY: 0.5},
    ...
    "AutoFilter": {
        "Frequency": {DEFAULT_SENSITIVITY_KEY: 1},
    ...
    "Eq8": {
        "Band": {DEFAULT_SENSITIVITY_KEY: 0.5},
    ...
    "Resonator": {
        "II Pitch": {DEFAULT_SENSITIVITY_KEY: 0.5},
        "III Pitch": {DEFAULT_SENSITIVITY_KEY: 0.5},
        "IV Pitch": {DEFAULT_SENSITIVITY_KEY: 0.5},
        "V Pitch": {DEFAULT_SENSITIVITY_KEY: 0.5},
    },
    "InstrumentVector": {
        "Osc 1 Pitch": {DEFAULT_SENSITIVITY_KEY: 10.0, FINE_GRAINED_SENSITIVITY_KEY: 0.4},
        "Osc 2 Pitch": {DEFAULT_SENSITIVITY_KEY: 10.0, FINE_GRAINED_SENSITIVITY_KEY: 0.4},
    },
    "Shifter": {"Mode": {DEFAULT_SENSITIVITY_KEY: 0.05}, "Pitch Bend Range": {DEFAULT_SENSITIVITY_KEY: 10.0}},
    "StringStudio": {"Octave": {DEFAULT_SENSITIVITY_KEY: 0.05}, "Semitone": {DEFAULT_SENSITIVITY_KEY: 0.1}},
