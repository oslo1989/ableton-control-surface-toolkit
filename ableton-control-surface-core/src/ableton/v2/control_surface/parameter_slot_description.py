...
class ParameterSlotDescription(EventObject):
    ...
    def set_parameter_host(self, host):
        ...
        self._ParameterSlotDescription__on_condition_value_changed.replace_subjects(
            [find_parameter(name, self._parameter_host) for name in params_names],
        )
        ...
        self._conditions.append(
            {
                ...
                CONDITIONS_LIST_NAME_KEY: [{CONDITION_NAME_KEY: parameter_name, OPERAND_NAME_KEY: AND}],
            },
        )
        self._default_parameter_name = ""
        self._display_name_transformer = None
    ...
    def chain_condition(self, operand, parameter_name):
        self._conditions[-1][CONDITIONS_LIST_NAME_KEY].append(
            {CONDITION_NAME_KEY: parameter_name, OPERAND_NAME_KEY: operand},
        )
        return self
    ...
    def is_available(self, value):
        self._add_condition_predicate(
            lambda p: liveobj_valid(p) == value,
        )
        return self
