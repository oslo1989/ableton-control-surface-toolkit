    ...
    def __init__(
        ...
        **k,
        ...
        if value_items is None:
            value_items = []
        (super().__init__)(a, display_value_conversion=display_value_conversion, **k)
        ...
        self._property_slot = self.register_slot(
            Slot(listener=(self.notify_value), event_name=source_property, subject=(self._property_host)),
        )
...
class EnumWrappingParameter(InternalParameterBase, PropertyHostMixin):
    ...
    def _get_index(self):
        return self._from_index(
            int(getattr(self._index_property_host, self._index_property))
...
class IntegerParameter(InternalParameter):
    def __init__(
        ...
        integer_value_property_name=None,
        min_value=None,
        max_value=None,
