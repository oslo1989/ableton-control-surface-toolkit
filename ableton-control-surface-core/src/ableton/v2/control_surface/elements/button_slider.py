...
class ButtonSliderElement(SliderElement):
        ...
        if not (value != 0 or sender.is_momentary()):
            ...
            if liveobj_valid(self._parameter_to_map_to):
                if self._parameter_to_map_to.is_enabled:
                    ...
                    param_value = (
                        old_div(param_range * index_of_sender, len(self._buttons) - 1) + self._parameter_to_map_to.min
                    )
    ...
    def _on_parameter_changed(self):
        ...
        midi_value = int(
            old_div(127 * abs(self._parameter_to_map_to.value - self._parameter_to_map_to.min), param_range),
        )
